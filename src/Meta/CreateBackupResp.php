...
class CreateBackupResp
{
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->meta = new \Nebula\Meta\BackupMeta();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('CreateBackupResp');
        if ($this->code !== null) {
        ...
        if ($this->meta !== null) {
            ...
            $xfer += $output->writeFieldBegin('meta', TType::STRUCT, 3);

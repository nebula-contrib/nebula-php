...
class ListSessionsResp
{
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i554 = 0; $_i554 < $_size550; ++$_i554) {
                            $elem555 = null;
                            $elem555 = new \Nebula\Meta\Session();
                            $xfer += $elem555->read($input);
                            $this->sessions []= $elem555;
                        }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ListSessionsResp');
        if ($this->code !== null) {
        ...
        if ($this->sessions !== null) {
            ...
            $xfer += $output->writeFieldBegin('sessions', TType::LST, 3);
            $output->writeListBegin(TType::STRUCT, count($this->sessions));
            foreach ($this->sessions as $iter556) {
                $xfer += $iter556->write($output);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }

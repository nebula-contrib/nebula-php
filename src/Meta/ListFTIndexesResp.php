...
class ListFTIndexesResp
{
                ...
                case 3:
                    if ($ftype == TType::MAP) {
                        ...
                        for ($_i502 = 0; $_i502 < $_size498; ++$_i502) {
                            $key503 = '';
                            $val504 = new \Nebula\Meta\FTIndex();
                            $xfer += $input->readString($key503);
                            $val504 = new \Nebula\Meta\FTIndex();
                            $xfer += $val504->read($input);
                            $this->indexes[$key503] = $val504;
                        }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ListFTIndexesResp');
        if ($this->code !== null) {
        ...
        if ($this->indexes !== null) {
            ...
            $xfer += $output->writeFieldBegin('indexes', TType::MAP, 3);
            $output->writeMapBegin(TType::STRING, TType::STRUCT, count($this->indexes));
            foreach ($this->indexes as $kiter505 => $viter506) {
                $xfer += $output->writeString($kiter505);
                $xfer += $viter506->write($output);
            }
            $output->writeMapEnd();
            $xfer += $output->writeFieldEnd();
        }

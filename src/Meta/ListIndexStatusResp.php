...
class ListIndexStatusResp
{
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i353 = 0; $_i353 < $_size349; ++$_i353) {
                            $elem354 = null;
                            $elem354 = new \Nebula\Meta\IndexStatus();
                            $xfer += $elem354->read($input);
                            $this->statuses []= $elem354;
                        }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ListIndexStatusResp');
        if ($this->code !== null) {
        ...
        if ($this->statuses !== null) {
            ...
            $xfer += $output->writeFieldBegin('statuses', TType::LST, 3);
            $output->writeListBegin(TType::STRUCT, count($this->statuses));
            foreach ($this->statuses as $iter355) {

...
class DeleteTagsRequest
{
                    ...
                    if ($ftype == TType::MAP) {
                        ...
                        for ($_i258 = 0; $_i258 < $_size254; ++$_i258) {
                            ...
                            for ($_i265 = 0; $_i265 < $_size261; ++$_i265) {
                                $elem266 = null;
                                $elem266 = new \Nebula\Storage\DelTags();
                                $xfer += $elem266->read($input);
                                $val260 []= $elem266;
                            }
                            $xfer += $input->readListEnd();
                            $this->parts[$key259] = $val260;
                        }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('DeleteTagsRequest');
        ...
        if ($this->parts !== null) {
            ...
            foreach ($this->parts as $kiter267 => $viter268) {
                $xfer += $output->writeI32($kiter267);
                $output->writeListBegin(TType::STRUCT, count($viter268));
                foreach ($viter268 as $iter269) {

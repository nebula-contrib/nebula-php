...
class MemberChangeReq
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->peer = new \Nebula\Common\HostAddr();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MemberChangeReq');
        ...
        if ($this->add !== null) {
            $xfer += $output->writeFieldBegin('add', TType::BOOL, 4);
            $xfer += $output->writeBool($this->add);
            $xfer += $output->writeFieldEnd();
        }
